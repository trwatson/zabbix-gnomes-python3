...
parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter,description='Creates new Zabbix hostgroups.', epilog="""
...
if args.silent:
    for group in args.hostgroup:
        test=zapi.hostgroup.exists(name=group)
        if test==False:
                groups.append(group)
